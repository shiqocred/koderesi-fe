          ...
          >
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  className={cn(
                    "p-0 h-7 w-7 bg-transparent text-black dark:text-white hover:dark:bg-gray-900",
                    is_owner ? "hover:bg-green-300" : "hover:bg-gray-200"
                  )}
                >
                ...
                <Command>
                  <CommandGroup>
                    <CommandList>
                      <CommandItem
                        onSelect={() =>
                          onOpen("edit-chat", { id, message, isAdmin: true })
                        }
                        disabled={!is_owner}
                      ...
                      <CommandItem
                        ...
                        onSelect={() =>
                          onOpen("delete-chat", { id, isAdmin: true })
                        }
                      >
